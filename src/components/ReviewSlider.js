...
export default function VerticalSwiper() {
  return (
    <div className="slider-box d-none-sm">
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-4">
                <div className="comment-card">
                  ...
                  <h6 className="text">
                    가방이 무척 무거웠던 날로 기억한다. 중앙학술정보관에서
                    나눠줬던 책이었던 것 같다. 가방이무거워서 나눠주는 책을
                    가져가야 할지 말지 고민했지만, 좋은 책을 마다할 이유는
                    없으니까! 가져오고 나서는 이제 고학년이라 취업에 한참 관심이
                    많아져서, 이 책을 소장할 수 있게 된 것에 조금 감사했다.
